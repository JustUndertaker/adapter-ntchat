...
class PictureMessageEvent(Event):
    """接收图片消息"""
...
class ViedeoMessageEvent(Event):
    """接收视频消息"""
...
class LocationMessageEvent(Event):
    """接收位置消息消息"""
